---
name: debate-system
description: 辩论备赛系统。用户给出辩题和持方时激活，自动完成资料检索、正方立论、攻防对战、裁判评判，输出完整飞书文档。支持完整流程和分步调用（仅资料/仅立论/仅攻防/仅裁判）。触发词：辩题、立论、攻防、辩论资料、帮我准备辩论。
---
...
5. **飞书文档放入文件夹** `Qey5fKwF7lZxXWd01TycvrPknJc`
